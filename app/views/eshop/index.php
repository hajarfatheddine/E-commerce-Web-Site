...
<!-- et c est elle qui fqit appel a cette vue (page) :index.php-->
<!-- chaque vue a un un controleur : classe de type Controleur>-->
	
<?php $this->view("eshop/slider",$data); ?> 	
					...
					<div class="features_items"><!--features_items-->
						...
						<?php else : ?>
							...
							<div class='alert-danger' style='max-width:350px;margin:auto;text-align:center;'>
							 <h4> Aucun produit n'est disponible ! <h4> </div> <br> <br>
